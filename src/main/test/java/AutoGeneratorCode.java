...
public class AutoGeneratorCode {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/demo_ssm?useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
        ...
        pc.setModuleName("");
        pc.setParent("demo.ssm");//这语句和上面语句，自动生成在com.learn.mybatisplu.AutoGeneratorCode目录下
...
//        mpg.setTemplate(templateConfig);
        ...
        strategy.setInclude("employee");  // 生成哪个表
